      ...
      >
        ...
        <div className="relative h-[250px] w-full max-w-3xl px-4 sm:h-[300px]">
          {mounted ? (
            ...
            <div className="absolute inset-0 overflow-y-auto rounded-2xl border border-[#0047AB] bg-[#090909]/50 p-6 shadow-xl backdrop-blur-sm sm:p-12">
              <div className="flex h-full flex-col items-center justify-center text-center">
                <h3
                  className="mb-4 font-pixelify text-2xl font-semibold text-white sm:mb-6 sm:text-3xl"
                  style={{
